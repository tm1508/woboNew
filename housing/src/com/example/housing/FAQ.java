	...
	public void setContent(){
		...
		accordion.setStyleName("startseite");
		  ...
		  accordion.addTab(new Label(), "Hier finden Sie häufig gestellte Fragen und Antworten",FontAwesome.CHEVRON_CIRCLE_DOWN);
			...
			accordion.addTab(layout_1, "zu Wohnungsangebote als Anbieter",FontAwesome.THUMB_TACK);//Tab 2 hinzufügen
	        ...
	        final Label label_8 = new Label("Ist ein Angebot nicht mehr aktuell und der Anbieter löscht dieses Angebot, wird es automatisch aus allen Listen gelöscht.");
			sub_accordion_2.addTab(label_8, "Warum ist ein Wohnungsangebot in meinen Favoriten verschwunden?", FontAwesome.QUESTION);
			
			final Label label_9 = new Label("Um ein Anfrage senden zu können, müssen Sie sich zunächst als DH-Student verifizieren. \nKlicken Sie anschließend auf das gewünschte Angebot. Am Ende der Seite befindet sich ein Button \"Anfragen\", drücken Sie diesen. \nNun kommen Sie zum Anfrageformular. In dem Textfeld können Sie nun Ihre Anfrage formulieren und mit einem Klick auf den Button \"Anfrage versenden\" wird die Anfrage an den Anbieter weitergeleitet.");
			sub_accordion_2.addTab(label_9, "Wie kann ich eine Anfrage für ein Wohnungsangebot senden?", FontAwesome.QUESTION);
