...
public class NavigationAdmin extends CustomComponent {
	...
	public NavigationAdmin() {
		...
		//Suche nach ID
		MenuBar.Command sucheId = new MenuBar.Command() {
			public void menuSelected(MenuItem selectedItem) {
				String name = "SucheNachId";
				getUI().getNavigator().addView(name, new SucheNachId());
				getUI().getNavigator().navigateTo(name);
		...
		//Alle User
		MenuBar.Command alleUser = new MenuBar.Command() {
			
			@Override
			public void menuSelected(MenuItem selectedItem) {
				
				List<User> allUsers = new UserProvider().getAllUsers();
				
				String name = "Angebotsliste";
				getUI().getNavigator().addView(name, new UserListe(allUsers));
				getUI().getNavigator().navigateTo(name);
