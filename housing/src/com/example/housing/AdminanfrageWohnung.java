...
public class AdminanfrageWohnung extends CustomHorizontalLayout implements View {
	...
	protected void sendEMail() {
		...
		//Email an Admin (CC)
		SendEMail.sendEmailAlias("wohnungsboerse_dh@web.de", "wohnungsboerse_dh@web.de", "Admin_Wohnungsboerse_DHBW", "Offer-ID " + angebot.getIdOffer() + ": Kopie Administratoren-Nachricht", copy);
	}
